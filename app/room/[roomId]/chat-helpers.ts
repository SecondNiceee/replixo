// Форматирование, общее с личным чатом, живёт в @/lib/chat-format
// (formatTime, formatFileSize, isImageAttachment). Здесь — только специфика
// комнаты: цвета имён по peerId и «прочитано всеми участниками».
